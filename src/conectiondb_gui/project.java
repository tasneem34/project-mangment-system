...
public class project extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jRadioButton1.setFont(new java.awt.Font("Arial Black", 1, 16)); // NOI18N
        jRadioButton1.setForeground(new java.awt.Color(255, 255, 255));
        jRadioButton1.setText("ADMIN");

        jRadioButton2.setBackground(new java.awt.Color(51, 51, 51));
        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setFont(new java.awt.Font("Arial Black", 1, 16)); // NOI18N
        jRadioButton2.setForeground(new java.awt.Color(255, 255, 255));
        jRadioButton2.setText("TEAM LEADER");
        ...
        jRadioButton3.setFont(new java.awt.Font("Arial Black", 1, 16)); // NOI18N
        ...
        jRadioButton4.setFont(new java.awt.Font("Arial Black", 1, 16)); // NOI18N
...
int login = database.checkLogin(user);
        if(jRadioButton4.isSelected ()&& login==1){
        ...
        else if(jRadioButton3.isSelected()&& login==3){
            PROJECT_MANAGER pm = new PROJECT_MANAGER();
            pm. setSize (780,500);
            pm.setVisible(true);
             this.dispose();
        }
        else if(jRadioButton2.isSelected()&& login==2){
            TEAM_LEADER tl= new TEAM_LEADER(database.findId(user));
            tl. setSize (780,590);
            tl.setVisible(true);
             this.dispose();
        }
        else if(jRadioButton1.isSelected()&& login==4){
            ADMIN a= new ADMIN();
            a. setSize (780,500);
            a.setVisible(true);
             this.dispose();
